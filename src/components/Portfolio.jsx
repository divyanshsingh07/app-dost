...
import { EyeIcon, CodeBracketIcon, GlobeAltIcon, DevicePhoneMobileIcon, ArrowRightIcon, CheckBadgeIcon, ClockIcon } from '@heroicons/react/24/outline'
...
function Portfolio() {
  ...
  return (
    <section id="portfolio" className="py-16 sm:py-20 lg:py-24 bg-linear-to-br from-white via-slate-50/30 to-blue-50/30 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 relative">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl lg:text-6xl leading-tight">
        ...
        {/* Projects Grid with View All Button */}
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-6 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3">
          ...
          {filteredProjects.length > 2 && (
            <div
              ...
              className="group relative overflow-hidden rounded-3xl bg-linear-to-br from-blue-600 via-purple-600 to-blue-800 shadow-lg ring-1 ring-blue-200/60 backdrop-blur-sm transition-all duration-300 hover:shadow-2xl hover:ring-blue-300/60 cursor-pointer"
            >
              {/* Card Content */}
              <div className="relative aspect-[4/3] p-6 flex flex-col items-center justify-center text-white overflow-hidden">
                ...
                <div className="relative z-10 text-center">
                  ...
                  <p className="text-sm text-blue-100 leading-relaxed mb-4">
                    Explore our complete portfolio of {filteredProjects.length} projects across all categories
                  </p>
                  
                  {/* Arrow */}
                  <div className="inline-flex items-center gap-2 rounded-xl bg-white/20 backdrop-blur-sm px-4 py-2 text-sm font-semibold text-white transition-all duration-200 group-hover:bg-white/30 group-hover:scale-105">
                    <span>See All</span>
